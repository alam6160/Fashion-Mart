              ...
              @if(isset($related_product[0]))
                    ...
                    <li>
                        ...
                        <figcaption>
                            ...
                            <span class="aa-product-price">TK {{$related_product_attr[$productArr->id][0]->price}}</span><span class="aa-product-price"><del>TK {{$related_product_attr[$productArr->id][0]->mrp}}</del></span>
                        </figcaption>
                        </figure>                          
                    </li>  
                    @endforeach    
