            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
                ...
                <div class="cellphone hidden-xs">
                  <p><span class="fa fa-phone"></span>01303531296</p>
                </div>
                <!-- / cellphone -->

              </div>
              <div class="email">
                <p><i class="fa fa-envelope"></i></span>fashionmart@gmail.com</p>
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  ...
                  @else
                    <li><a href="{{url('/login.login_process')}}" data-toggle="modal" data-target="#login-modal">Login</a></li>
                  @endif
                ...
                <a href="{{url('registration')}}">SignUp</a>
                  ...
                  <!-- <li><a href="{{url('registration')}}" class="aa-myaccount-register"id="frmRegistration" >SignUp</a></li> -->
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="{{url('/')}}">
                  ...
                  <p>Fashion<strong>Mart</strong> <span>Your Fashion Partner</span></p>
                </a>
                <!-- img based logo -->
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <div class="aa-cartbox-info">
                        ...
                        <p>{{$cartItem->qty}} * TK {{$cartItem->price}}</p>
                      </div>
                    </li>
                    @endforeach                  
                    <li>
                ...
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    ...
                    <address>
                      ...
                      <p><span class="fa fa-phone"></span>01303531296</p>
                      <p><span class="fa fa-envelope"></span>fashionmart@gmail.com</p>
                    </address>
      ...
      <div class="container">
        ...
        <div class="col-md-12">
          <div class="aa-footer-bottom-area">
            <p>Designed by <a href="#"> Md.Shah Alam</a></p>
        ...
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <div id="popup_login">
            ...
            {{method_field('post')}}
              ...
              <p class="aa-lost-password"><a href="{{url('registration')}}" onclick="forgot_password()">Lost your password?</a></p>
          ...
          <div id="popup_forgot" style="display:none;">
            ...
            <form class="aa-login-form" id="frmForgot">
              ...
              <div class="aa-register-now">
                Login Form?<a href="{{url('login_process')}}" onclick="show_login_popup()">Login now!</a>
              </div>
              @csrf
            </form>
          </div>
