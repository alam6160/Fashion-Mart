                        ...
                        <li>
                          <figure>
                            ...
                            <figcaption>
                              ...
                              <span class="aa-product-price">TK {{$home_product_attr[$productArr->id][0]->price}}</span><span class="aa-product-price"><del>TK {{$home_product_attr[$productArr->id][0]->mrp}}</del></span>
                            </figcaption>
                          </figure>                          
                        </li>  
                        @endforeach    
